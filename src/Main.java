...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        // Load the FXML file
        Orthophoniste ortho = new Orthophoniste("fellahi", "abderraouf", "setif", "0551611983", "ma_fellahi@esi.dz","123");
       // Consultation consultation = new Consultation("10:00","2024-05-27","touat","malak",20);
