...
public class SinscrireController {
    ...
    void inscription(ActionEvent event) {
        ...
        // if (adresse.getText().isEmpty() || email.getText().isEmpty() ||
        // motdepasse1.getText().isEmpty()
        // || motdepasse2.getText().isEmpty() ||
        // nom.getText().isEmpty() || numero.getText().isEmpty() ||
        // prenom.getText().isEmpty()) {
        // Util.afficherErreur("Erreur d'inscription", "Tous les champs doivent etre
        // remplis ");
        // return;
        // }
        ...
        // Util.afficherErreur("Erreur d'inscription", "Les mts de passes ne
        // correspondent pas");
        // return;
        // }

        // if (!validerEmail(email.getText())) {
        // Util.afficherErreur("Erreur lors de l'inscription", "Format d'email
        // incorrect.");
        // return;
        // }
        // if (!validerNumeroTelephone(numero.getText())) {
        // Util.afficherErreur("Erreur lors de l'inscription", "Format numero telephone
        // incorrect.");
        // return;
        // }
        // if (motdepasse1.getText().length() < 8) {
        // Util.afficherErreur("Erreur lors de l'inscription", "Le mot de passe doit
